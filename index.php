...
//     if (empty($errors)) {
//         if (saveToDatabase($name, $email, $phone)) {
//             echo "<p style='color: green;'>Pemesanan berhasil disimpan!</p>";
//         } else {
//             echo "<p style='color: red;'>Gagal menyimpan pemesanan!</p>";
//         }
//     } else {
//         echo "<p style='color: red;'>Formulir memiliki kesalahan. Silakan perbaiki dan coba lagi.</p>";
//     }
// }
?>
...
<body>
    ...
    <section class="about-section">
        ...
        <p>Selamat datang di QuickRent, aplikasi penyewaan mobil dan motor terdepan di Purwokerto yang dirancang untuk memberikan kemudahan dan fleksibilitas dalam memenuhi kebutuhan transportasi Anda. Dengan QuickRent, Anda dapat dengan mudah menemukan dan menyewa berbagai jenis kendaraan, mulai dari mobil keluarga yang nyaman, SUV tangguh, hingga motor lincah untuk mobilitas perkotaan.</p>
        <p>Kami memahami bahwa setiap perjalanan memiliki kebutuhan yang berbeda. Oleh karena itu, QuickRent menawarkan beragam pilihan kendaraan terbaru dengan kondisi prima, yang selalu kami jaga melalui perawatan berkala. Baik Anda membutuhkan kendaraan untuk perjalanan wisata, urusan bisnis, atau sekadar mobilitas sehari-hari, QuickRent hadir dengan solusi yang tepat.</p>
