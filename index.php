...
<body>
    ...
    <section id="home" class="hero">
        ...
        <div class="hero-content">
            <h1>Temukan solusi transportasi terbaik untuk kebutuhan Anda di Purwokerto dengan harga terjangkau dan
                pelayanan prima</h1>
            <div class="filter-box">
                ...
                <div class="filter-options">
                    ...
                    <label for="transmission-select">Transmisi:</label>
                    <select id="transmission-select">
                        <option value="">⚙️ Semua Transmisi</option>
                    ...
                    <label for="service-select">Pilihan Layanan:</label>
                    <select id="service-select">
                        <option value="">🧑‍✈️ Dengan pengemudi</option>
    ...
    <section class="about-section">
        ...
        <p>Selamat datang di QuickRent, aplikasi penyewaan mobil dan motor terdepan di Purwokerto yang dirancang untuk
            memberikan kemudahan dan
            fleksibilitas dalam memenuhi kebutuhan transportasi Anda. Dengan QuickRent, Anda dapat dengan mudah
            menemukan dan menyewa berbagai jenis kendaraan,
            mulai dari mobil keluarga yang nyaman, SUV tangguh, hingga motor lincah untuk mobilitas perkotaan. </p>
        <p>Kami memahami bahwa setiap perjalanan memiliki kebutuhan yang berbeda. Oleh karena itu, QuickRent menawarkan
            beragam
            pilihan kendaraan terbaru dengan kondisi prima, yang selalu kami jaga melalui perawatan berkala. Baik Anda
            membutuhkan kendaraan
            untuk perjalanan wisata, urusan bisnis, atau sekadar mobilitas sehari-hari, QuickRent hadir dengan solusi
            yang tepat.</p>
    ...
    <section id="reviews" class="reviews-section">
        ...
        <div class="reviews-container">
            <div class="review-card">
                ...
                <p class="review-text">Pelayanan sangat memuaskan, kendaraan bersih dan terawat. Proses pemesanan juga
                    mudah dan cepat.</p>
                <p class="reviewer">Timora L. <span>- Mahasiswa</span></p>
            </div>
            <dilass="review-card">
                <div class="rating">★★★★☆</div>
                <p class="review-text">Mobil yang disewakan dalam kondisi prima, harga sewa juga terjangkau.
                    Recommended!</p>
    ...
    <footer>
        <div class="footer-container">
            <div class="footer-section">
                <h3>QuickRent</h3>
                <p>Kami melayani sewa sesuai dengan opsi kebutuhan Anda yaitu per 12 jam, 24 jam, harian, mingguan, dan
                    bulanan.</p>
                <p>Menyediakan layanan rental mobil dan motor berkualitas dengan pilihan kendaraan terlengkap, harga
                    terjangkau, dan proses pemesanan yang mudah untuk memenuhi kebutuhan transportasi Anda selama di
                    kota ini, kami ahlinya.</p>
            </div>
            <div class="footer-section">
                <h3>Kontak Kami</h3>
