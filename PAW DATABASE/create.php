...
//     if (empty($errors)) {
//         if (savePemesanan($name, $email, $phone)) {
//             $message = "<p style='color: green;'>Pemesanan berhasil disimpan!</p>";
//         } else {
//             $message = "<p style='color: red;'>Gagal menyimpan pemesanan!</p>";
//         }
//     }
// }
// ?>
...
<head>
    ...
    <title>Create Booking - QuickRent</title>
...
<body>
    ...
    <footer>
        <div class="footer-container">
            <!-- Konten footer sesuai file index.php -->
